/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: cdf01a3d3ccb7ee1109b02c64e1d954b)
// Runtime types generated with workerd@1.20250507.0 2025-05-12 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		OPENAI_API_KEY: string;
		LINEAR_OAUTH_TOKEN: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENAI_API_KEY" | "LINEAR_OAUTH_TOKEN">> {}
}
